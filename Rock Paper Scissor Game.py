...
The Game:
Player chooses a certain number of rounds.
...
def print_welcome():
    ...
    N = int(input('Enter number of rounds to play (Eg. 5):\t'))
    print('You will play '+str(N)+' games against the AI')
